...
It is in German because otherwise the joke would not work lol.

The demo path is fully live. Headlines, debate turns, referee verdicts, and
audio are generated by real services at runtime, and failures should be shown
honestly when they happen.
...
The point of the demo is that one morning headline quickly becomes a short live
show.
